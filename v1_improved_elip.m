...
% Integrate the weight distribution over the span x
Total_Weight_Newtons = trapz(x, w_weight);

% Convert to Mass (kg) if needed
Total_Mass_kg = Total_Weight_Newtons / 9.81;

% Display the result
fprintf('Total Wing Weight: %.2f N\n', Total_Weight_Newtons);
